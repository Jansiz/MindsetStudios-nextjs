        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                ...
                <figure className="relative isolate">
                  ...
                  <figcaption className="mt-6 text-sm leading-6 text-gray-300">
                    <strong className="font-semibold text-white">Sam Samia</strong> CEO at MindsetStudios
                  </figcaption>
                </figure>
              </div>
            </div>
            <div>
              ...
              <dl className="mt-10 grid grid-cols-2 gap-8 border-t border-gray-900/10 sm:grid-cols-4">
              </dl>
              <div className="mt-10 flex">
                <a href="#" className="text-base font-semibold leading-7 text-black">
                  Learn more about our media services <span aria-hidden="true">&rarr;</span>
                </a>
              </div>
            </div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <div className="mt-10 flex">
                <a href="#" className="text-base font-semibold leading-7 text-black">
                  Learn more about our music services <span aria-hidden="true">&rarr;</span>
                </a>
              </div>
              </div>
              <div className="lg:pr-4">
              <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                ...
                <figure className="relative isolate">
                  ...
                  <figcaption className="mt-6 text-sm leading-6 text-gray-300">
                    <strong className="font-semibold text-white">Julia dav</strong> CTO at MindsetStudios
                  </figcaption>
                </figure>
              </div>
            </div>
